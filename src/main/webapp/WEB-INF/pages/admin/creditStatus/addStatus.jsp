    ...
    <form:form method="POST" modelAttribute="status" class="form-signin">
        ...
        <spring:bind path="status">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <spring:message code="addStatus.placeholder.status" var="Namestatus"/>
                <form:input type="text" path="status" class="form-control" placeholder='${Namestatus}' autofocus="true"/>
