...
<div class="formForInput">
    <form:form method="POST" modelAttribute="status" class="form-signin">
        <h2 class="form-signin-heading">
            <spring:message code="head.editStatus.head"/>
        </h2>
        <spring:bind path="status">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <spring:message code="addStatus.placeholder.status" var="Namerole"/>
                <form:input type="text" path="status" class="form-control" placeholder='${Namerole}' autofocus="true"/>
